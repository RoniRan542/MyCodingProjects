...
{
public:
    Square() : m_down_left({0, 0}), m_up_right({0, 0})
    {
        // empty
    }
    Square(std::pair<unsigned int, unsigned int> down_left, std::pair<unsigned int, unsigned int> up_right);

    std::pair<unsigned int, unsigned int> m_down_left;
    std::pair<unsigned int, unsigned int> m_up_right;
};

Square::Square(std::pair<unsigned int, unsigned int> down_left, std::pair<unsigned int, unsigned int> up_right) : m_down_left(down_left), m_up_right(up_right)
{
    // empty
}
